class Wadb < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/LinDevHard/wadb/releases/download/v1.0.0/wadb-darwin-arm64-1.0.0.tar.gz"
      sha256 "4076bbd6fa0e04e362035db903ac460d29e7ff07046025cca301e3003f836186"
    end

    on_intel do
      url "https://github.com/LinDevHard/wadb/releases/download/v1.0.0/wadb-darwin-amd64-1.0.0.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/LinDevHard/wadb/releases/download/v1.0.0/wadb-linux-arm64-1.0.0.tar.gz"
      sha256 "743f298cd458164d6e7dfca2e97cd04b946134cbb4d7737ce51fa070d79bbcef"
    end

    on_intel do
      url "https://github.com/LinDevHard/wadb/releases/download/v1.0.0/wadb-linux-amd64-1.0.0.tar.gz"
